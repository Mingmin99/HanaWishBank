    ...
    <div class="ButtonContainer ">
        <div class="row">
            ...
            <div class="col">
                ...
                <a class="registerPurchasePlanListButton" href="index.jsp"> <img
