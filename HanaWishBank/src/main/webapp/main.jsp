					...
					<div class="section1">
						...
						<div class="content">
							...
							<div class="img-container">
								<c:url var="logoUrl" value="/mainpattern.png" />
				...
				<div class="carousel-item">
					<div class="section1">
						<div class="content">
							...
							<div class="img-container">
								<c:url var="logoUrl" value="/mainwishlist.png" />
				...
				<div class="carousel-item">
					<div class="section1">
						<div class="content">
							...
							<div class="img-container">
								<c:url var="logoUrl" value="/mainsave.png" />
			...
			<table class="notice-table">
				...
				<tr>
					<td colspan="2" class="notice-content">HANA BANK 서비스 점검으로 인해
						8월 10일 01:00 ~ 03:00까지 서비스 이용이 일시적으로 불가능합니다.</td>
				</tr>
				<tr>
				...
				<tr>
					<td colspan="2" class="notice-content">HANA BANK에서 사용자 보안 강화를
						위해 비밀번호 변경 안내를 발송하였습니다. 확인해주세요!</td>
				</tr>
			</table>
		</div>
	</div>
