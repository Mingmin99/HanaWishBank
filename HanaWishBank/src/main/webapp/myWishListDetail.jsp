...
<body>
	...
	<main>
		...
		<div class="wishListDetailTitle">
			<img src="<c:url value='/ic_calculator.svg' />" alt="Main Wish List"
			...
			<div class="row">
				...
				<div class="col">
					<div class="icCoffeeCalculator">
						<img src="<c:url value='ic_coffeeCalculator.svg' />"
		...
		<div class="ButtonContainer ">
			<div class="row">
				<div class="col">
					<c:url var="deleteWishListButton" value="/btn_deleteWishList.svg" />
