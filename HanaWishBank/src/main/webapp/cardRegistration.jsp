...
<body>
	...
	<main>
		<div class="title">
			<img src="<c:url value='ic_cards.svg' />" alt="Main Wish List"
				width="80" style="vertical-align: middle; margin-right: 10px;">
			나의 카드등록
		</div>

		<div class="description-box">
			<div class="description-text1">💳 일상 속 가장 자주 사용하는 카드를 등록해보세요!
				🧐</div>
			<div class="description-text2">➡️ 등록 후 나의 소비패턴을 확인해보세요 ~</div>
		</div>
		<hr class="divider">
